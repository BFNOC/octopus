            ...
            >
                ...
                {!searchExpanded ? (
                    <motion.button
                        ...
                        className={buttonVariants({ variant: "ghost", size: "icon", className: "h-9 w-9 rounded-xl transition-none hover:bg-transparent text-muted-foreground hover:text-foreground" })}
                    >
                    ...
                    <motion.div
                        layoutId="search-box"
                        className="flex items-center gap-2 h-9 px-3 rounded-xl border z-10"
