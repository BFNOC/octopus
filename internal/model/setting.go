...
func (s *Setting) Validate() error {
	...
	case SettingKeySSEHeartbeatInterval, SettingKeySSEPreStreamHeartbeatDelay:
		...
		return nil
	case SettingKeyRelayLogKeepEnabled, SettingKeyRelayWSUpgradeEnabled, SettingKeyResponsesWSEnabled, SettingKeyGroupHealthEnabled, SettingKeyStatsSiteModelBackfilled:
